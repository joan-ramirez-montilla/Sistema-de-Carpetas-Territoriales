<div class="space-y-6">
        ...
        <table class="w-full text-sm">
            <thead class="bg-gray-50 dark:bg-gray-800">
                <tr>
                    ...
                    <th class="px-4 py-3 text-left font-medium text-gray-700 dark:text-gray-200">Descripción</th>
                    <th class="px-4 py-3 text-left font-medium text-gray-700 dark:text-gray-200">Precio</th>
                    <th class="px-4 py-3 text-left font-medium text-gray-700 dark:text-gray-200">Duración</th>
    ...
    <div class="flex justify-end">
        {{ $services->links('components.flux-pagination') }}
    </div>
