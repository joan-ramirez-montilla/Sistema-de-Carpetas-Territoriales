    ...
    ">
            ...
            <section class="py-20 md:py-28 bg-white px-6">
                <div class="max-w-6xl mx-auto">
                    ...
                    <div class="relative mb-16">
                        ...
                        <h2 class="text-3xl md:text-4xl font-bold ml-16"
                            style="font-family: 'Playfair Display', serif;">
                            Nuestro <span style="color: var(--color-primary);">Equipo</span> de Expertos
                        </h2>
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12">
                        ...
                        <div class="group cursor-pointer">
                            <div
                                class="relative overflow-hidden rounded-2xl mb-4 transition-all duration-500
                                group-hover:shadow-xl">
                                <img src="https://images.unsplash.com/photo-1605497788044-5a32c7078486" alt="Carlos"
                            ...
                            <div class="text-center">
                                <h3 class="font-semibold text-lg mb-1">Carlos</h3>
                                <p class="text-sm text-gray-500">Estilista Senior</p>
                            </div>
                        </div>
                        ...
                        <div class="group cursor-pointer">
                            <div
                                class="relative overflow-hidden rounded-2xl mb-4 transition-all duration-500
                                group-hover:shadow-xl">
                                <img src="https://images.unsplash.com/photo-1599351431613-18ef1fdd27e1" alt="Miguel"
                                    class="w-full h-64 object-cover transition-transform duration-700
                                    group-hover:scale-105">
                                <div
                                    class="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent
                            ...
                            <div class="text-center">
                                <h3 class="font-semibold text-lg mb-1">Miguel</h3>
                                <p class="text-sm text-gray-500">Barbero Clásico</p>
                            </div>
                        </div>

                        {{-- Card con iniciales --}}
                        <div class="group">
                            <div class="relative h-64 rounded-2xl mb-4 overflow-hidden transition-all duration-500
                                group-hover:shadow-xl"
                                style="background: linear-gradient(135deg, #1f2937 0%, #111827 100%);">
                                <div class="absolute inset-0 flex items-center justify-center">
                                    <span class="text-6xl font-bold text-white/90 tracking-widest">Jo</span>
                                </div>
                                <div
                            ...
                            <div class="text-center">
                                <h3 class="font-semibold text-lg mb-1">José</h3>
                                <p class="text-sm text-gray-500">Especialista en Barbas</p>
                            </div>
                        </div>
                        ...
                        <div class="group">
                            <div class="relative h-64 rounded-2xl mb-4 overflow-hidden transition-all duration-500
                                ...
                                style="background: linear-gradient(135deg, #1f2937 0%, #111827 100%);">
                                <div class="absolute inset-0 flex items-center justify-center">
                                    <span class="text-6xl font-bold text-white/90 tracking-widest">Lu</span>
                                </div>
                                <div
                                    class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent
                                    opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                            ...
                            <div class="text-center">
                                <h3 class="font-semibold text-lg mb-1">Luis</h3>
                                <p class="text-sm text-gray-500">Colorista Profesional</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="grid md:grid-cols-2 gap-12 md:gap-16 items-center">
                        ...
                        <div class="relative">
                            ...
                            <div class="relative rounded-2xl overflow-hidden shadow-xl">
                                <iframe class="w-full h-96 border-0" src="{{ $companySetting->map_url }}"
                                    loading="lazy" style="filter: grayscale(20%);">
                                </iframe>
                                <div
                ...
                <div class="relative flex flex-col items-center">
                    ...
                    <button onclick="openBookingModal()"
                       ...
                       box-shadow: 0 8px 25px -5px rgba(0, 0, 0, 0.3);">
                        <i
                            class="fas fa-calendar-alt text-xl md:text-2xl group-hover:scale-110 transition-transform"></i>
                    </button>
                </div>
            </div>
        ...
        <script>
            function openBookingModal() {
                ...
                // o redirigir a la página de reservas
                alert('Redirigiendo al sistema de reservas...');
                // Ejemplo: window.location.href = '/reservar';
            }
        </script>
    </body>
